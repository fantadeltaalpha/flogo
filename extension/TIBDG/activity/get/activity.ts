...
@WiContrib({})
@Injectable()
export class DatagridGetActivityContribution extends WiServiceHandlerContribution {
  ...
  value = (
    ...
    if (fieldName === "dgConnection") {
      //Connector Type must match with the category defined in connector.json
      return Observable.create((observer) => {
        let connectionRefs = [];
        WiContributionUtils.getConnections(this.http, "TIBDG").subscribe(
          (data: IConnectorContribution[]) => {
